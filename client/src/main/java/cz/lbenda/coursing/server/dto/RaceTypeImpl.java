 ...
 */
@Entity(name = "RaceType")
public class RaceTypeImpl extends NumberLineImpl implements RaceType {

    public NumberLineType getNumberLineType() { return NumberLineType.RaceType; }
}
